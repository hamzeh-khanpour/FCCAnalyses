...
// Hamzeh ==================================================================  
  //Get flavour association of jet - noabsvalue
  ROOT::VecOps::RVec<int> get_flavour_noabsvalue(ROOT::VecOps::RVec<fastjet::PseudoJet> in, ROOT::VecOps::RVec<edm4hep::MCParticleData> MCin);   
// Hamzeh ==================================================================
