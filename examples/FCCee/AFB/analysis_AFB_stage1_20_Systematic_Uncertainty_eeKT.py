...
processList = {
    'p8_ee_Zbb_ecm91_rFactB_835':{'fraction':1},
    'p8_ee_Zbb_ecm91_rFactB_875':{'fraction':1},
    'p8_ee_Zbb_ecm91_SpaceShower_alphaSvalue_06':{'fraction':1},
    'p8_ee_Zbb_ecm91_SpaceShower_alphaSvalue_25':{'fraction':1},
}

#Mandatory: Production tag when running over EDM4Hep centrally produced events, this points to the yaml files for getting sample statistics
prodTag     = "/yaml_Systematic_Uncertainty_AFB_FCCee/" 

#Optional: output directory, default is local running directory 
outputDir   = "/eos/experiment/fcc/ee/tmp/Hamzeh-Khanpour-FCNC-FCCee/AFB_FCCee_Udine_ICTP_20_Systematic_Uncertainty_eeKT/"
...
#               .Define("jade_FCCAnalysesJets_ee_ES","JetClustering::clustering_jade(0.5, 2, 2, 1, 0)(pseudo_jets)")     #get the jets out of the struct
               ...
               .Define("jade_FCCAnalysesJets_ee_ES","JetClustering::clustering_ee_kt(2, 2, 1, 0)(pseudo_jets)")     # eeKT
...
#               .Define('RP_CosTheta',     'EVT_thrust.at(7)')
