# Forward-Backward-Asymmetry January 2024 - sig + bkgs
# Udine/ICTP FCC group


#Mandatory: List of processes
processList = {
'p8_ee_Zbb_ecm91':{'fraction':0.1,  'chunks':8},  # to read the Zbb signal samples        -- 10 percent
'p8_ee_Zcc_ecm91':{'fraction':0.1,  'chunks':8},  # to read the Zcc background samples    -- 10 percent
'p8_ee_Zuds_ecm91':{'fraction':0.1, 'chunks':8},  # to read the Zuds background samples   -- 10 percent
'p8_ee_Zmumu_ecm91':{'fraction':1,  'chunks':1},  # to read the Zmumu background samples  -- Full statistics
}
...
outputDir   = "/eos/experiment/fcc/ee/tmp/Hamzeh-Khanpour-FCNC-FCCee/AFB_FCCee_Udine_ICTP_22_sig_bkgs_eeKT_New_Tagging/" 
...
compGroup = "group_u_THEORY.u_t3"          # to use the CERN theory
...
#################--------------------------------------------------------------------------
             ...
             #===================================================================================
               ...
               .Define("cambridge_jets_ee_genkt_ES_btag",      "JetTaggingUtils::get_btag(cambridge_jets_ee_genkt_ES_flavour, 0.80, 0.004, 0.0005, 0.007)")
               .Define("cambridge_jets_ee_genkt_ES_ctag_true", "JetTaggingUtils::get_ctag(cambridge_jets_ee_genkt_ES_flavour, 1.0)") 
               .Define("cambridge_jets_ee_genkt_ES_ctag",      "JetTaggingUtils::get_ctag(cambridge_jets_ee_genkt_ES_flavour, 0.80, 0.02, 0.009, 0.025)") 
             ...
             #===================================================================================
               ...
               .Define("kt_jets_ee_genkt_ES_btag",      "JetTaggingUtils::get_btag(kt_jets_ee_genkt_ES_flavour, 0.80, 0.004, 0.0005, 0.007)")
               .Define("kt_jets_ee_genkt_ES_ctag_true", "JetTaggingUtils::get_ctag(kt_jets_ee_genkt_ES_flavour, 1.0)") 
               .Define("kt_jets_ee_genkt_ES_ctag",      "JetTaggingUtils::get_ctag(kt_jets_ee_genkt_ES_flavour, 0.80, 0.02, 0.009, 0.025)") 
...
# We are using the ee KT Durham jet clustering algorithms in exclusive mode with exactly two jets
                
               .Define("jade_FCCAnalysesJets_ee_ES","JetClustering::clustering_ee_kt(2, 2, 1, 0)(pseudo_jets)")     # ee KT Durham jet clustering algorithm
               ...
               .Define("jade_jets_ee_ES_btag",      "JetTaggingUtils::get_btag(jade_jets_ee_ES_flavour, 0.80, 0.004, 0.0005, 0.007)")
               .Define("jade_jets_ee_ES_ctag_true", "JetTaggingUtils::get_ctag(jade_jets_ee_ES_flavour, 1.0)")
               .Define("jade_jets_ee_ES_ctag",      "JetTaggingUtils::get_ctag(jade_jets_ee_ES_flavour, 0.80, 0.02, 0.009, 0.025)")
