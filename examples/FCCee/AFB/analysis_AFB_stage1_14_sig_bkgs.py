...
'p8_ee_Zcc_ecm91':{'fraction':0.1, 'chunks':10}, #Run 50% of the statistics in two files named <outputDir>/p8_ee_WW_ecm240/chunk<N>.root
'p8_ee_Zuds_ecm91':{'fraction':0.1, 'chunks':10}, #Run 20% of the statistics in one file named <outputDir>/p8_ee_ZH_ecm240_out.root (example on how to change the output name)
...
outputDir   = "/eos/experiment/fcc/ee/tmp/Hamzeh-Khanpour-FCNC-FCCee/AFB_FCCee_Udine_ICTP_14/" 
